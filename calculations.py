...
with tab2:
    ...
    strike_abs_start = st.sidebar.text_input('[Can be empty] Only strikes above:', value='3900')
    strike_abs_end = st.sidebar.text_input('[Can be empty] Only strikes under:', value='3975')
