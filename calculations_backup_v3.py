...
start_date = st.sidebar.date_input('Load Historical data from:', value=pd.to_datetime('2000-01-01'))
...
if total_instances > 0:
    ...
    st.write(f"The S&P 500 moved by {-(round(percent_fall, 2))}% or more within {days} or less days {count} times in history, which represents a {probability:.2%} probability")
else:
...
strike_abs_start = st.sidebar.text_input('Strike Abs Start', value='3950')
strike_abs_end = st.sidebar.text_input('Strike Abs End', value='4000')
